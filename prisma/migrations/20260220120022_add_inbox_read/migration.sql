...
INSERT INTO "new_Note" ("createdAt", "eventDate", "id", "mediaUrl", "memberId", "rejectedAt", "senderId", "status", "text", "title", "type") SELECT "createdAt", "eventDate", "id", "mediaUrl", "memberId", "rejectedAt", "senderId", "status", "text", "title", "type" FROM "Note";
DROP TABLE "Note";
